...
## Party
- **Location:** Thundertree, morning after the mine's fall. The mine itself is **fully cleared, top to bottom** — service cut, holding area, commander's post, barracks, processing area, and the Warden's man's chamber all taken, the front entrance broken from inside to link up with Kaldur's line. A full search of the mine (Thundertree warriors + freed captives) turned up minor coin/gear and, more importantly, the sealed-off original Ashpit chamber — Darkhawk's own origin, now visited and emotionally closed (see Loose Threads). The dead honored, both grieving families told in person, Darkhawk and Mara engaged.
