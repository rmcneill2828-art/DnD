...
- **Milestone worth flagging:** solving the Ashpit's founding mystery and surviving the Voreth duel (bear-spirit bond answering past Relentless Rage's own failure) reads as milestone-tier by the campaign's own standard — worth deciding on a DMG Epic Boon (or an equivalent bear-spirit-flavored custom boon) with the player next session rather than assumed here.
