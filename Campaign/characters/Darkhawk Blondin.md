...
- **The Shared Reckoning (Session 31, the Standing Ring):** Darkhawk asked the bear-spirit to stop holding "the count" apart from him and bond fully as an equal partner — offered unarmored, unarmed, and completely open, held through the test by entering a deliberately balanced rage rather than resisting or breaking under it. The bond completed as true partnership rather than protection alone. New permanent effects: **advantage on saving throws against being scried, tracked, or divined by anything hostile**; and once per long rest, the bear-spirit can speak one truth directly through him, its own words rather than his (narrative tool, DM's discretion on trigger/content). Marked by new lines etched into his forearm, bear and stone interwoven, alongside the old claw-shaped scar.
- **The Honest Ledger (Session 32, House Corvane's chantry, Ravenshollow):** having named "the count" as theft directly to the Raven Queen and won her genuine attention, she marked him with a lasting gift: he can always tell, without doubt, when a choice being asked of him or of anyone standing with him is being quietly weighed toward the enemy's counterfeit ledger rather than freely made. Passive, always-on sense (narrative tool — DM signals it when relevant, no roll required).
- **Epic Boon — Boon of the Bear's Last Stand (Session 51, the burned court):** earned surviving the wagered duel with Voreth — Death Ward spent, Relentless Rage succeeding once and then failing, and a final unscripted plea to the bear-spirit bond (pushed over the line only by Wren's Bend Luck) bringing him back from unconsciousness after the contest was already lost. The bond's answer is now permanent and reliable rather than a one-time miracle: **Relentless Rage's DC no longer escalates with repeated uses before a long rest — it stays DC 10 every time.** And the bond no longer requires rage itself to answer: **if reduced to 0 hit points by damage at any time, raging or not, he can still attempt the Relentless Rage save (DC 10) to drop to 1 HP instead** — the bear-spirit holding him up on its own terms, not just while the rage burns.
- **Kethrun's Ward (Session 44, the Standing Ring):** named aloud, in front of the full party and Vosk's hunters, a real feeling of unworthiness to lead Urskelde — and chose out loud to set it down rather than let it stand as the final word on him. Answered the exact gap the bear-spirit's totem never covered (psychic harm, which targets self-worth rather than the body). Permanent **resistance to psychic damage** from anything weaponizing doubt or judgment against him — Kathrivex's audits and constructs foremost among them. Not immunity; the doubt can still be real. Just no longer able to cut as deep as it used to.
...
- **A matched pair of silver-inlaid dueling daggers**, exceptional craftsmanship, no maker's mark, from Duskgate's strongroom. **Identified (Session 47, Brother Aldous at Ravenshollow):** genuinely silvered steel, no active enchantment — real craft, no magic. Silvered edges still bite where plain steel doesn't (certain undead, certain fiends).
- **Two silver rings, identified (Session 47, Brother Aldous):** matched set, same maker, different rank-marks from the mountain keep's cabinet and strongroom chest. Ring 1 (plain chevron, overseer-tier): resistance to necrotic damage; while worn, can't be tracked, scried, or divined by anything hostile. Ring 2 (senior mark): the same privacy ward, plus the wearer can sense nearby active soul-tribute threads/debt-bindings without needing to see them directly — a real tool for finding tribute sites before walking in blind. Neither currently worn; carried for whenever the situation calls for one.
...
- **Ideals:** Justice, not law. The strong exist to protect the weak, not exploit them — arenas and thrones run on the same rotten logic, and he's done serving either.
- **Bonds:** He will find whoever betrayed him and left him for dead, and make them answer. He needs to know who he was before the ring took him — tribe, family, name.
- **Flaws:** Deep, near-automatic distrust of authority, law enforcement, and anyone claiming power over others "for their own good" — it's gotten him into fights he didn't need. When he senses betrayal, rage can override judgment.

## Backstory
Taken from his tribe as a child, Darkhawk doesn't remember much of the mountains beyond fragments — cold air, a carved trophy he's kept ever since, a name that isn't the one the slavers gave him. He was raised in the gladiator ring, sold, traded, and finally trained into one of its best. He fought his way to the top of that brutal ladder — and when he refused to throw a fight for the house's profit, they made an example of him and left him for dead in the pit.
...
## Current Status
- Conditions: none active — end of Session 51, back at the ward-ruin camp overlooking the burned court, fully recovered after a long rest following the duel with Voreth.
- HP: 189 / 189 (full)
- Rages: 4/4 available. Action Surge: available. Second Wind, Stone's Endurance, Superiority dice, Helm's crit-insurance: all available. Relentless Rage's escalating DC has reset to 10 for its next use.
- **The duel with Voreth (Session 51):** wagered honest single combat over Malphestor's sponsorship — lost. Voreth's opening Multiattack alone dealt 88 after mitigation; Death Ward absorbed a killing blow in round 3; Relentless Rage held once (DC 10) then failed at DC 15, dropping Rurik unconscious. A last, unscripted plea to the bear-spirit bond to rise came up one point short on a DC 20 Constitution save — until Wren's Bend Luck reaction pushed it through. Woke at 12 HP, seconds after Voreth had already sealed the binding contract. Malphestor's claim through Voreth is now permanently closed; Voreth himself was genuinely shaken by what he witnessed and gave his own personal (non-contractual) word that Corren's Landing, Urskelde, and the party's allies are safe from him.
- **The Ashpit mystery, resolved (Session 51):** Voreth confirmed the original hit was his own authority — an "audit flag" on a child already registering as an anomaly by the network's ledger-logic — and that nothing further came openly afterward out of fear, not mercy: killing Rurik once his account was mercy-closed would have proven the ledger isn't absolute. Loose thread closed after 20+ sessions.
- **A private prayer at the cairns (Session 50):** asked no god for anything for himself, only protection for the people he loves whatever the burned court brings. A raven watched him a long moment and flew north before he could read anything certain into it; Mara independently saw it pass over her too. No mechanical effect confirmed — but Voreth's own genuine shock at the bear-spirit's answer during the duel is the first real evidence something took notice.
- **Milestone confirmed (Session 51):** solving the Ashpit's founding mystery and surviving the Voreth duel earned the **Boon of the Bear's Last Stand** (see Features & Traits) — Relentless Rage no longer escalates in DC and no longer requires raging to trigger.
- Inspiration: fresh — earned back for tonight's roleplay (the wager negotiation, the prayer, and the bear-spirit invocation) exactly as previously owed.
...
- **Forward base:** Urskelde ("the bear's shelter," formerly the Bear Cave/Ashpit/the mine), Thundertree ground — fully cleared and reclaimed, now being expanded into a settlement under its own name. Fallow Cross and Old Harlan's Forge remain as standing footholds but are no longer the active base.
