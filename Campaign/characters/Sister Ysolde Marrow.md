...
- **Ideals:** Debts — moral, legal, or infernal — should be settled honestly, in the open, not left to fester in shadow.
- **Bonds:** Her order's archive on infernal contracts, which she now realizes was never meant to just sit unused.
- **Flaws:** Can lecture past the point anyone needs the detail, out of genuine enthusiasm rather than arrogance.

## Backstory
A scholar-cleric of Thossia's order at the regional seat — the same city Ravenshollow is chartered from, though she'd never made that connection until this campaign handed it to her directly. Her order concerns itself with judgment and the settling of debts after death, which in practice has meant decades of oath disputes, inheritance judgments, and the occasional genuine haunting, but never anything as consequential as a living, ongoing infernal bargain.
...
- **Milestone level-up (Session 42, Halloway's Reach):** Cleric 16 → 17 — earned alongside the rest of the party for securing Halloway's Reach and closing a third account (the freed courier) in front of witnesses. Gained a 9th-level spell slot and **Keeper of Souls** (see Features). No ASI at 17 (Cleric's ASI levels are 4/8/12/16/19). Rolled +5 (d8) + CON mod 2, now **118 max**.
