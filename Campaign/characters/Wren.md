...
- HP: 82 / 82 (full)
- Sorcery points: 13/15 (2 spent, Quickened Spell on Haste)
- Spell slots: 2/4 1st (Chaos Bolt, Disguise Self), 3/3 2nd, 2/3 3rd (Haste), 2/3 4th (Dimension Door), 2/2 5th, 0/1 6th (Chain Lightning), 0/1 7th (Chain Lightning, upcast — her 6th-level slot was already spent, so the second casting used her 7th-level slot instead)
- Tides of Chaos: **spent again** (Controlled Chaos triggered on the forced surge from Haste — picked the stronger of two rolls, a defensive ward giving attacks against her disadvantage for 1 minute)
