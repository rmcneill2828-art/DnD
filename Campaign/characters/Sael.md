...
**Race:** Wood Elf
**Class & Level:** Druid 9 (Circle of the Moon)
**Background:** Hermit
...
- **Proficiency bonus:** +4 (character level 9)
...
**Wood Elf**
- Fleet of Foot: base speed 35 ft (reflected above)
- Mask of the Wild: can attempt to hide even when only lightly obscured by natural phenomena
- Keen Senses: proficiency in Perception (reflected above)

**Druid**
- **Druidic:** knows the secret druidic language.
- **Spellcasting:** Wisdom-based. Spell save DC 16, spell attack +8. Prepares spells daily (WIS mod + druid level = 13 prepared) from the full druid list. Slots: 4 (1st), 3 (2nd), 3 (3rd), 2 (4th).
  - Commonly prepared: *Goodberry, Cure Wounds, Entangle, Pass without Trace, Barkskin, Speak with Animals, Conjure Animals, Spike Growth, Protection from Poison, Wind Wall, Locate Creature, Freedom of Movement.*
...
- Herbalism kit
- A worn traveling cloak, deliberately unremarkable
- Minimal coin — she's lived off the land more than off trade for years

## Personality
- **Traits:** Watches before speaking, same instinct that's kept her hidden for years. Dry, quiet humor once trust is actually earned.
- **Ideals:** The wild — and the people it marks — deserve protecting, even at personal cost.
- **Bonds:** Darkhawk/Rurik, the one intervention she's never regretted, whatever else she's second-guessed about the years of silence since.
- **Flaws:** Defaults to distance and secrecy even when honesty would serve better — a habit built from decades of solitary watching, not easily broken.

## Backstory
A solitary bear-kin druid, part of an old, informal tradition rather than any organized circle, Sael has spent most of her long life following the wrongness in the land the way others follow a trail. She happened across Ashpit by chance years ago, meaning only to look and leave — until she witnessed a young pit-fighter refuse to finish a beaten opponent, and felt something old and primal answer inside her before she'd consciously decided anything. She used her bear shape to pull him from the wreckage after the crowd's attention moved on, closed the near-fatal wound with druidic healing, and got him clear.
